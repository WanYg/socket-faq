...
static const u_char *md5_body(md5_ctx_t *ctx, const u_char *data,
    size_t size);
...
void
md5_update(md5_ctx_t *ctx, const void *data, size_t size)
{
    size_t  used, free;
...
void
md5_final(u_char result[16], md5_ctx_t *ctx)
{
    size_t  used, free;
...
#if (AD_HAVE_LITTLE_ENDIAN && AD_HAVE_NONALIGNED)
...
static const u_char *
md5_body(md5_ctx_t *ctx, const u_char *data, size_t size)
{
    uint32_t       a, b, c, d;
