...
static void
sha_transform(sha1_ctx_t *sha_info)
{
    int i;
 ...
 */
void
sha1_update(sha1_ctx_t *ctx, const void *buffer_, size_t count)
{
 ...
 */
void
sha1_final(sha1_ctx_t *ctx, uint8_t digest[SHA1_DIGEST_SIZE])
{
    int count, i, j;
